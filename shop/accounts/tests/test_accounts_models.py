...
class ShopUserModelTest(SettingsTestCases):
    ...
    def test_validators_meta(self):
        ...
        print(self.test_user._meta.get_field('password').verbose_name, '=',
              self.test_user.password)
        print(self.test_user._meta.get_field('last_login').verbose_name, '=',
              self.test_user.last_login)
        print(self.test_user._meta.get_field('username').verbose_name, '=',
              self.test_user.username)
        print(self.test_user._meta.get_field('first_name').verbose_name, '=',
              self.test_user.first_name)
        print(self.test_user._meta.get_field('middle_name').verbose_name, '=',
              self.test_user.middle_name)
        print(self.test_user._meta.get_field('last_name').verbose_name, '=',
              self.test_user.last_name)
        print(self.test_user._meta.get_field('email').verbose_name, '=',
              self.test_user.email)
        print(self.test_user._meta.get_field('is_superuser').verbose_name, '=',
              self.test_user.is_superuser)
        print(self.test_user._meta.get_field('is_staff').verbose_name, '=',
              self.test_user.is_staff)
        print(self.test_user._meta.get_field('is_active').verbose_name, '=',
              self.test_user.is_active)
        print(self.test_user._meta.get_field('is_activated').verbose_name, '=',
              self.test_user.is_activated)
        print(self.test_user._meta.get_field('date_joined').verbose_name, '=',
              self.test_user.date_joined)

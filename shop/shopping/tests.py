...
class ShoppingTestCases(TestCase):
    ...
    def setUp(self) -> None:    # предварительные настройки
        ...
        self.test_good_01 = GoodsDB.objects.create(
            ...
            price=Decimal('543.55'),
            presence=True,
            category=self.test_category_child,
            description='TestTestTestTest TestTestTestTest',
        )
        self.test_good_02 = GoodsDB.objects.create(
            title='TestGood02',
            brand=self.test_brand,
            price=Decimal('432.44'),
            presence=True,
            category=self.test_category_child,
            description='TestTestTestTest TestTestTestTest',
        )
        ...
        self.test_review_01 = ReviewsDB.objects.create(
            review_title='TestReview01',
            user_name=user,
            review_text='01TestTestTestTest 01TestTestTestTest',
            good=self.test_good_01,
            review_rating='80',
        )
        self.test_review_02 = ReviewsDB.objects.create(
            review_title='TestReview02',
            user_name=user,
            review_text='02TestTestTestTest 01TestTestTestTest',
            good=self.test_good_02,
            review_rating='40',
        )
        self.test_image_01 = GalleryDB.objects.create(photo=image_01, product=self.test_good_01)
        self.test_image_02 = GalleryDB.objects.create(photo=image_02, product=self.test_good_02)

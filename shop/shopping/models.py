...
class BrandNameDB(models.Model):
    """
    Model BrandNameDB to save new brands to database
    """
...
class CategoryDB(MPTTModel):
    """
    Model CategoryDB to save new categories to database
    """
...
class ReviewsDB(models.Model):
    """
    Model ReviewsDB to save new reviews to database
    """
    ...
    date_at_review = models.DateTimeField(
            auto_now_add=True,
...
class GalleryDB(models.Model):
    """
    Model GalleryDB to save new photos to database
    """

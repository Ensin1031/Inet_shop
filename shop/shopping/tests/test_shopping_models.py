...
class CategoryModelTest(SettingsTestCases):
    ...
    def test_valid_category_by_many_to_many_field_in_promo(self):
        self.assertEqual('testPromoAction', self.test_category.from_category.all()[0].promo_title)
...
class BrandModelTest(SettingsTestCases):
    ...
    def test_validators_meta(self):
        ...
        print(self.test_brand._meta.get_field('title').verbose_name, '=', self.test_brand.title)
        print(self.test_brand._meta.get_field('slug').verbose_name, '=', self.test_brand.slug)

    def test_valid_slug(self):
        self.assertEqual('testbrand', self.test_brand.slug)

    def test_valid_brand_by_many_to_many_field_in_promo(self):
        self.assertEqual('testPromoAction', self.test_brand.from_brand.all()[0].promo_title)
...
class GoodModelTest(SettingsTestCases):
    ...
    def test_validators_meta(self):
        ...
        print(self.test_good._meta.get_field('title').verbose_name, '=', self.test_good.title)
        print(self.test_good._meta.get_field('brand').verbose_name, '=', self.test_good.brand)
        print(self.test_good._meta.get_field('price').verbose_name, '=', self.test_good.price)
        print(self.test_good._meta.get_field('presence').verbose_name, '=', self.test_good.presence)
        print(self.test_good._meta.get_field('category').verbose_name, '=', self.test_good.category)
        print(self.test_good._meta.get_field('description').verbose_name, '=', self.test_good.description)
        print(self.test_good._meta.get_field('date_at').verbose_name, '=', self.test_good.date_at)
        print(self.test_good._meta.get_field('slug').verbose_name, '=', self.test_good.slug)
    ...
    def test_valid_description(self):
        self.assertEqual('TestDescription TestDescription TestDescription', self.test_good.description)
...
class GallaryModelTest(SettingsTestCases):
    """test model GalleryDB"""

    def test_validators_meta(self):
        print('----------test model GalleryDB----------')
        print('-------test image №1-------')
        print(self.test_photo_01._meta.get_field('photo').verbose_name, '=', self.test_photo_01.photo.url)
        print(self.test_photo_01._meta.get_field('product').verbose_name, '=', self.test_photo_01.product)
        print(self.test_photo_01._meta.get_field('slug').verbose_name, '=', self.test_photo_01.slug)
        print('-------test image №2-------')
        print(self.test_photo_02._meta.get_field('photo').verbose_name, '=', self.test_photo_02.photo.url)
        print(self.test_photo_02._meta.get_field('product').verbose_name, '=', self.test_photo_02.product)
        print(self.test_photo_02._meta.get_field('slug').verbose_name, '=', self.test_photo_02.slug)
    ...
    def test_valid_photo_01_photo_url(self):
        self.assertEqual('/media' + self.test_image_good_01, self.test_photo_01.photo.url)
    ...
    def test_valid_photo_02_photo_url(self):
        self.assertEqual('/media' + self.test_image_good_02, self.test_photo_02.photo.url)
...
class ReviewsModelTest(SettingsTestCases):
    ...
    def test_validators_meta(self):
        ...
        print(self.test_review_01._meta.get_field('date_at_review').verbose_name, '=',
              self.test_review_01.date_at_review)
        print(self.test_review_01._meta.get_field('good').verbose_name, '=',
              self.test_review_01.good)
        print(self.test_review_01._meta.get_field('review_rating').verbose_name, '=',
        ...
        print(self.test_review_02._meta.get_field('date_at_review').verbose_name, '=',
              self.test_review_02.date_at_review)
        print(self.test_review_02._meta.get_field('good').verbose_name, '=',
              self.test_review_02.good)
        print(self.test_review_02._meta.get_field('review_rating').verbose_name, '=',
    ...
    def test_valid_review_text_by_review_01(self):
        self.assertEqual('ReviewText01 ReviewText01 ReviewText01', self.test_review_01.review_text)

    def test_valid_date_at_by_review_01(self):
        self.assertEqual(self.test_date, self.test_review_01.date_at_review.date())
    ...
    def test_valid_review_text_by_review_02(self):
        self.assertEqual('ReviewText02 ReviewText02 ReviewText02', self.test_review_02.review_text)

    def test_valid_date_at_by_review_02(self):
        self.assertEqual(self.test_date, self.test_review_02.date_at_review.date())

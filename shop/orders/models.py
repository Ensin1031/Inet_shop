...
class OrderDB(models.Model):
    """
    Model OrderDB to save the details of new orders to database
    """
    ...
    def get_total_price(self):
        """
        The function to return the total order cost
        """
...
class OrderItemDB(models.Model):
    """
    Model OrderItemDB to save of order's lists to database
    """
    ...
    def get_cost(self):
        """
        The function to return the total position cost
        """
